      ...
      <SectionMain>
        ...
        <CardBox>
          <div className={'mb-4'}>
            ...
            <p>{patient_records?.client?.first_name ?? 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Nutritionist</p>

            <p>{patient_records?.nutritionist?.first_name ?? 'No data'}</p>
          </div>
          ...
          <FormField label='Multi Text' hasTextareaHeight>
            <textarea
              className={'w-full'}
              disabled
              value={patient_records?.blood_work}
            />
          </FormField>
          ...
          <FormField label='Multi Text' hasTextareaHeight>
            <textarea
              className={'w-full'}
              disabled
              value={patient_records?.supplements}
            />
          </FormField>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Weight</p>
            <p>{patient_records?.weight || 'No data'}</p>
          </div>
          ...
          <FormField label='Multi Text' hasTextareaHeight>
            <textarea
              className={'w-full'}
              disabled
              value={patient_records?.additional_info}
            />
          </FormField>
          ...
          <div className={'mb-4'}>
            ...
            <p>{patient_records?.companie?.name ?? 'No data'}</p>
          </div>
