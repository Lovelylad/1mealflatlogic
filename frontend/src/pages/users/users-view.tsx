      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            ...
            <p>{users?.companie?.name ?? 'No data'}</p>
          </div>

          <>
            <p className={'block font-bold mb-2'}>Clients User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.clients_user &&
                      Array.isArray(users.clients_user) &&
                      users.clients_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
          ...
          <>
            <p className={'block font-bold mb-2'}>Nutritionists User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.nutritionists_user &&
                      Array.isArray(users.nutritionists_user) &&
                      users.nutritionists_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
              ...
              {!users?.nutritionists_user?.length && (
                <div className={'text-center py-4'}>No data</div>
              )}
            </CardBox>
          </>
