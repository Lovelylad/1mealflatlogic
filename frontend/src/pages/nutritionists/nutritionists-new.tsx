...
import { create } from '../../stores/nutritionists/nutritionistsSlice';
...
NutritionistsNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_NUTRITIONISTS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default NutritionistsNew;
