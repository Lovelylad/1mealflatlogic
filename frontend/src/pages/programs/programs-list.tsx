...
const ProgramsTablesPage = () => {
  ...
  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_PROGRAMS');
      ...
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          ...
          <div className='md:inline-flex items-center ms-auto'>
            <Link href={'/programs/programs-table'}>Switch to Table</Link>
          </div>
        </CardBox>
...
ProgramsTablesPage.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'READ_PROGRAMS'}>
      {page}
    </LayoutAuthenticated>
  );
};
