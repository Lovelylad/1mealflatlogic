...
const ListRecipes = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_RECIPES');
            ...
            <CardBox hasTable key={item.id} className={'rounded'}>
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>MealPlans</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter
                        .meal_plansManyListFormatter(item.meal_plans)
                        .join(', ')}
                    </p>
                  </div>
                </div>
