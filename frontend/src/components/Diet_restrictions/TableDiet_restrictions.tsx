...
import { loadColumns } from './configureDiet_restrictionsCols';
...
const TableSampleDiet_restrictions = ({
  filterItems,
  setFilterItems,
  filters,
  showGrid,
  ...
  const {
    ...
    loading,
    count,
    notify: diet_restrictionsNotify,
    refetch,
  } = useAppSelector((state) => state.diet_restrictions);
  ...
  useEffect(() => {
    if (diet_restrictionsNotify.showNotification) {
      notify(
        diet_restrictionsNotify.typeNotification,
        diet_restrictionsNotify.textNotification,
      );
    }
  }, [diet_restrictionsNotify.showNotification]);
  ...
  const handleEditAction = (id: string) => {
    router.push(`/diet_restrictions/${id}`);
  };

  const handleViewAction = (id: string) => {
    router.push(`/diet_restrictions/diet_restrictions-view/?id=${id}`);
  };
...
export default TableSampleDiet_restrictions;
