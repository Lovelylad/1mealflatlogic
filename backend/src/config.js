...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '332645c02ab47ef1b7a6a5384f4f4882',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Create a backend for a dietician to create meal pl <app@flatlogic.app>',
  ...
  project_uuid: '2351dfd6-a811-4d07-ba66-3d1523560df1',
  flHost:
