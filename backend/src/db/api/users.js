...
module.exports = class UsersDBApi {
  static async create(data, globalAccess, options) {
    ...
    await users.setCompanie(data.data.companie || null, {
      transaction,
    });
  ...
  static async update(id, data, globalAccess, options) {
    ...
    await users.setCompanie(data.companie || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.clients_user = await users.getClients_user({
      transaction,
    });

    output.nutritionists_user = await users.getNutritionists_user({
      transaction,
    });
    ...
    output.companie = await users.getCompanie({
      transaction,
    });
