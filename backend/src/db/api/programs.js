...
module.exports = class ProgramsDBApi {
  static async create(data, options) {
    ...
    await programs.setCompanie(data.companie || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.companie = await programs.getCompanie({
      transaction,
    });
  ...
  static async findAll(filter, globalAccess, options) {
    ...
    if (filter) {
      ...
      if (filter.title) {
        where = {
          ...where,
          [Op.and]: Utils.ilike('programs', 'title', filter.title),
        };
      }
  ...
  static async findAllAutocomplete(query, limit, globalAccess, organizationId) {
    ...
    if (query) {
      where = {
        [Op.or]: [
          { ['id']: Utils.uuid(query) },
          Utils.ilike('programs', 'title', query),
        ],
      };
    }
