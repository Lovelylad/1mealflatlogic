  ...
  static async search(searchQuery, currentUser, organizationId, globalAccess) {
    try {
      ...
      const tableColumns = {
        ...
        ebooks: ['title', 'description'],

        meal_plans: ['title', 'description'],

        nutritionists: ['first_name', 'last_name', 'email', 'phone'],

        patient_records: ['blood_work', 'supplements', 'additional_info'],

        programs: ['title', 'description'],

        recipes: ['title', 'ingredients', 'instructions'],
